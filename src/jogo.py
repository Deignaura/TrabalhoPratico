...
def _desenhar_pista(tela, offset=0):
    """Desenha marcações de pista animadas com scroll."""
    start = int(offset) % 80 - 80
    for y in range(start, ALTURA_TELA, 80):
...
def _loop_partida(tela, relogio, fonte_hud, fonte_grande, fonte_pequena, nome_jogador, sons=None):
    ...
    carro_y_min = ALTURA_TELA // 3
    carro_y_max = ALTURA_TELA - ALTURA_CARRO - 10
    offset_pista = 0.0
    ...
    while True:
        ...
        carro_y = mover_jogador_vertical(
            carro_y,
